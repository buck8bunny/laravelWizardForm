...
{{--    <form method="post" action="input.php" id="wizard" enctype=multipart/form-data>--}}
    <form method="post" action="{{ route('form_submission') }}" id="wizard" enctype=multipart/form-data>
        ...
        <section class="section-3">
            <div class="inner">
                ...
                <a href="{{ url('/members') }}" class="fa-3x" target = "_blank" style="color:green;margin:0 auto;width:100%;text-shadow: 2px 2px #1c87c9">
                    All members ({{ $totalRows }})
                </a>
            </div>
        </section>
    </form>
...
<script src="{{ asset('https://malsup.github.io/jquery.form.js') }}"></script>
<!-- JQUERY STEP -->
